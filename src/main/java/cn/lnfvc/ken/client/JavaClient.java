 ...
 * @Author: KenChen
 * @Description:
 * @Date: Create in  2021/8/19 上午10:56
        ...
        try {
            ...
            WebSocketClient client = new WebSocketClient(new URI(uri),new Draft_6455()) {
                ...
                public void onClose(int i, String s, boolean b) {
                    ...
                    log.info("Client:关闭连接:::" + "i = " + i + ":::s = " + s +":::b = " + b);
                }
                ...
                public void onError(Exception e) {
                    ...
                    log.error("Client:报错了:::" + e.getMessage());
                }
            ...
            while(client.getReadyState().ordinal() == 0){
                ...
                try {
                    ...
                    log.warn("Client:延迟操作出现问题，但并不影响功能");
